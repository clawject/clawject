...
//   }
//
//   static listenToRequestEnd(callback: () => void): void {
//
//   }
//
...
import {MainApplication} from './benchmark/clawject';

const t0 = performance.now();
const test = await ClawjectFactory.createApplicationContext(MainApplication);
