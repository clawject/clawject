...
class Application {
  ...
  @Bean @Lazy(false) @Scope('singleton') @Primary @Qualifier('3') @Internal /*@External*/ method() { return 123; }
  @Bean @Lazy(false) @Scope('singleton') @Primary @Qualifier('4') @Internal /*@External*/ get getter() { return 123; }
}
