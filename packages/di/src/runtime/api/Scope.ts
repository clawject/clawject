...
import { ClawjectDecorator, ModernClassDecorator, ModernClassFieldDecorator, ModernClassGetterDecorator, ModernClassMethodDecorator } from './decorators';
 ...
 * @public
 */
export const Scope: ClawjectDecorator<'Scope'> & ((scope: ScopeValue) => ScopeTarget) = () => {
