...
:::tip
Read more about [@Internal](/docs/overview/internal-external#when-target-is-bean) and [@External](/docs/overview/internal-external#when-target-is-bean-1).
:::
...
:::tip
Read more about [@Internal](/docs/overview/internal-external#when-target-is-imported-configuration) and [@External](/docs/overview/internal-external#when-target-is-imported-configuration-1).
:::
