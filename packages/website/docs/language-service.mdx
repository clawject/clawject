...
If you're using VSCode - you can install [Clawject VSCode Extension](https://todo.com) instead of `clawject-language-service` package.

If not - you can install `clawject-language-service` package and configure your editor to use it.
