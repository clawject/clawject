...
import { CompareClawjectWithOthers, CompareClawjectWithOthersComplex } from '../src/docs-components/Intro';

<CompareClawjectWithOthers />

When it comes to the more complex scenarios, like generic inside constructors - with Clawject,
...
<CompareClawjectWithOthersComplex />

As you can see - Clawject requires much less boilerplate code, not pollutes **business classes** and provides an intuitive,
declarative and **really** type-safe API where you can't miss a thing.
