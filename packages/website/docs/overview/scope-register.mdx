...
See [@Scope](/docs/overview/scope.mdx) and [Custom Scopes](/docs/advanced-concepts/custom-scopes.mdx) for more information.

## Methods overview

### `.registerScope`

This method allows you to register a new [Custom Scope](/docs/advanced-concepts/custom-scopes.mdx) and [use it](/docs/overview/scope.mdx) for beans.
