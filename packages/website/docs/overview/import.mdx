...
:::tip
Clawject will report you info in the IDE about the fact that the configuration is imported as [external](/docs/overview/internal-external#external) multiple times, and import can be omitted.
:::
