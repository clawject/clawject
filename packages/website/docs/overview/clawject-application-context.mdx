...
Let's define a simple application with a single bean and try to expose it using [ExposeBeans function](/docs/overview/expose-beans.mdx):
...
[@PostConstruct](/docs/overview/lifecycle.mdx#postconstruct) and [@PreDestroy](/docs/overview/lifecycle.mdx#predestroy) decorators:
