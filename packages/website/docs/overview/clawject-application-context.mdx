...
Let's define a simple application with a single bean and try to expose it using [ExposeBeans function](/docs/overview/expose-beans):
...
[@PostConstruct](/docs/overview/lifecycle.mdx#postconstruct) and [@PreDestroy](/docs/overview/lifecycle#predestroy) decorators:
