...
[beans and its dependencies](/docs/overview/bean.mdx#bean-dependencies),
[imported configurations](/docs/overview/import.mdx)
and [exposed beans](/docs/overview/expose-beans.mdx).
...
to expose beans and configuration imports to the container using [@Internal and @External](/docs/overview/internal-external.mdx) decorators.
:::
...
- [Define beans](/docs/overview/bean.mdx)
- [Import configurations](/docs/overview/import.mdx)
- [Define lifecycle methods](/docs/overview/lifecycle.mdx)
- [Export beans and re-export configuration imports to the container](/docs/overview/internal-external.mdx)
