...
See [@Scope](/docs/fundamentals/scope.mdx) and [Custom Scopes](/docs/guides/custom-scopes) for more information.

### Methods overview

#### `.registerScope()`

This method allows you to register a new [Custom Scope](/docs/guides/custom-scopes.mdx) and [use it](/docs/fundamentals/scope) for beans.
