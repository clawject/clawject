...
See [@Scope](/docs/fundamentals/scope) and [Custom Scopes](/docs/guides/creating-scope) for more information.

### Methods overview

#### `.registerScope()`

This method allows you to register a new [Custom Scope](/docs/guides/creating-scope) and [use it](/docs/fundamentals/scope) for beans.
