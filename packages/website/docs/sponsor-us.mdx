...
By supporting Clawject, you contribute to:
...
- Become a backer or sponsor on [OpenCollective](https://opencollective.com/clawject)
...
Thank you for considering supporting Clawject,
our new open source dependency injection framework.
