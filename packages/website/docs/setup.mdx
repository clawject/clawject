...
import { AddDependency } from '@site/src/docs-components/Setup';
...
import { TSPatchWebpackTSLoader } from '@site/src/docs-components/Setup';
...
import { TSPatchViteRollupPlugin } from '@site/src/docs-components/Setup';
...
import { WebpackTSLoader } from '@site/src/docs-components/Setup';
