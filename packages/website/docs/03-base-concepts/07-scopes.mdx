...
If you want to define your own scope, for example `HTTPRequestScope` - you can check out the [Custom Scopes](../04-advanced-concepts/02-custom-scopes.mdx) section.
